...
model_path = 'D:/SIH/working_classifier/image_class/inception.tflite'
...
image_path = 'D:/SIH/Datasets/Dataset_compiled/Abrus precatorius (Rosary Pea)/image1.jpg'  # Replace with the path to your image
...
print("Best Prediction:top_class_labels: ",top_class_labels[0])
print("Top Predicted Classes:", top_class_labels)
